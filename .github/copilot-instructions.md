...
The web application is a full-stack TypeScript application with modern tooling and containerized deployment.
...
- Styling should be encapsuled within components, avoid styling in "page.tsx" files
